...
##        CMDSTR="guidellm benchmark --target http://localhost:8000 --processor $PWD/Models/Llama-3.2-1B-Instruct --data "prompt_tokens=256,output_tokens=128" --profile concurrent --max-requests 100 --rate=${rate} --output-dir ${LOG_DIR}"
